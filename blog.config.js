...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dormo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱睡觉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-gamma-ruby-66.vercel.app/', // 网站地址
